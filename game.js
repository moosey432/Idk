(() => {
// Prevent duplicate classic-script evaluation from creating a second game loop.
if (window.__battleGameInitialized) return;
window.__battleGameInitialized = true;
